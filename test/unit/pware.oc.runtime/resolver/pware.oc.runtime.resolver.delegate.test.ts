...
import { emptyDb, type SessionView } from "../../../../src/pware.oc.opencode/resolver/index.js"
import { emptyOmo } from "../../../../src/pware.oc.omo/resolver/pware.oc.omo.resolver.boulder.js"
import {
  delegatesForSession,
  groupDelegates,
  reconcileDelegateStatus,
  type DelegateView,
} from "../../../../src/pware.oc.runtime/resolver/pware.oc.runtime.resolver.delegate.js"
...
function live(over: Partial<RuntimeSnapshot> = {}): RuntimeSnapshot {
