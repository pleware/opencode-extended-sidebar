...
| `×`                             | failed                                                        |
| `?` `⊘` `×` `◔` `!` `…` `•` `▶` `✓` | My work: awaiting an answer / interrupted / errors / running / ready to review / drafting / draft docs (muted document rows) / ready to start / finished |
